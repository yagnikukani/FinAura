        ...
        <div className='fixed top-0 right-0 left-0 z-50 flex justify-center items-center w-full h-[calc(100%-1rem)] max-h-full overflow-y-auto overflow-x-hidden bg-black/20 bg-opacity-50'>
            <div className='relative p-4 w-full max-w-2xl max-h-full'>
                ...
                <div className='relative bg-white rounded-lg shadow-sm'>
                    ...
                    <div className='flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-300 border-gray-700'>
                        <h3 className='text-lg font-medium text-shadow-gray-900 dark:text-gray-700'>
                            {title}
                        </h3>
